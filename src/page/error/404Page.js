            ...
            <div className="row">
              <div className="col-md-12">
                <div className="text-primary">
                  <div className="display-1 mb-3 font-weight-bold error-text">404</div>
                  <h1 className="h3  mb-1 font-weight-bold">Sorry, an error has occured, Requested Page not found!</h1>
                  <p className="h5 font-weight-normal mb-5 leading-normal">You may have mistyped the address or the page may have moved.</p>
                  <a className="btn btn-primary text-light mb-3 fs-18">Help</a>
